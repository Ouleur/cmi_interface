                                                ...
                                                <div class="row">
                                                    <div class=" col-md-6 form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7">
                                                               ...
                                                               <input type="text" name="nom" class="form-control col-md-7" required placeholder="ADOU"/>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class=" col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                                <select class="custom-select sexe-select col-md-7">
                                                                    <option selected>Selection du sexe</option>
                                                    ...
                                                    <div class=" col-md-6 form-group">
                                                        ...
                                                        <div class="col-md-7">
                                                        <input type="text" name="prenoms" class="form-control col-md-7" required placeholder="Norbert"/>
                                                        </div>
                                                    </div>
                                                    </div>
                                                    <div class=" col-md-6">
                                                        ...
                                                        <div class="col-md-7">
                                                        <input type="text" name="contact" class="form-control col-md-7" required placeholder="Ex: 45784512"/>
                                                        </div>
                                                    </div>
                                                    </div>
                                                    <div class=" col-md-6">
                                                       ...
                                                       <div class="col-md-7">
                                                        <input type="date" name="date_naiss" class="form-control col-md-7" required placeholder="Ex : 04/12/2000"/>
                                                        </div>
                                                    </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-7">
                                                        <input type="text" name="email" class="form-control col-md-7" required placeholder="Ex : info@cmi.ci"/>
                                                        </div>
                                                    </div>
                                                    </div>
                                                    <div class=" col-md-6">
                                                        ...
                                                        <div class="col-md-7">
                                                        <input type="text" name="lieu_naiss" class="form-control col-md-7" required placeholder="Ex : Yaokro"/>
                                                    </div>    
                                                </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class=" col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class=" col-md-12 form-group">
                                                                <div class="row">
                                                                <div class="col-md-3">Entreprise</div>
                                                                <div class="col-md-7">
                                                                <input type="text" name="entVisite" class="form-control " required placeholder="Norbert"/>
                                                                </div>
                                                                </div>
                                                            </div>
                                                            <div class=" col-md-12">
                                                    ...
                                                    <div class="col-md-6" style="height: 300px;">
                                                        ...
                                                        <div class="col-lg-8 acte_infirmier_med">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <button type="button" data-animation="false" class="btn-add-exeam-visit btn btn-pink waves-effect waves-light">Ajouter</button>
                                                                </div>
                                                        
                                                                <div class="col-lg-12">
                                                                    <table id="" class="table exam_visite_tb">
