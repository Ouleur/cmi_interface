    ...
    <div class="col-12">
        <div class="card m-b-20">
            <div class="card-block">
                ...
                <h4 class="mt-0 header-title">Liste des Examens</h4>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title mt-0" id="myLargeModalLabel">Nouvelle Profession</h5>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="card-block">
                                        ...
                                        <div class="form-group">
                                            <label >Type Examen</label>
                                            <div >
                                                <select  name="e_type" class="e_type custom-select">
