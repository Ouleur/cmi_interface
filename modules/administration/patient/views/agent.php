...
<div class="col-sm-12">
    <div class="card m-b-20">
        <div class="card-block">  
            <div class="col-md-3">
                <button type="button" class="btn btn-success waves-effect waves-light btn-open-modal" data-toggle="modal" data-target=".fade"><i class="mdi mdi-plus-circle" ></i>Ajouter</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-dialog modal-lg modal-full-height">
            <div class="modal-content">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group row">
                                                                ...
                                                                <!-- <div class="col-lg-12">
                                                                    <div class="col-md-12"> -->
                                                                       <img class="img-thumbnail avatar" alt="200x200" style="width: 155px; height: 150px;" src="assets/images/users/avatar-1.jpg" data-holder-rendered="true" id="avatar_img_photo">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    ...
                                                                    <select name="civilite" class=" civilite-select custom-select">
                                                                        ...
                                                                        <option value="Mlle">Démoiselle</option>
                                                                    </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <select name="entite-select" class="entite-select custom-select">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <select name="lieu-select" class="lieu-select custom-select">
                                                                        <option value="0" selected>Selection du lieu</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <select name="contrat-select" class="contrat-select custom-select">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                   <select name="categorie-select" class="categorie-select custom-select">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <select name="prof-select" class="prof-select custom-select">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                <label for="txtCompanyShipping" class="col-lg-3 col-form-label">Type patient</label>
                                                                <div class="col-lg-9">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary waves-effect waves-light submit add_submit" id="">Enregistrer</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
