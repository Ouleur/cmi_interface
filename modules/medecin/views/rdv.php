    ...
    <div class="modal-dialog modal-lg modal-full-height" role="document" >
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn_end_dossier mt-0 btn btn-dark" data-dismiss="modal">Fermer le Dossier</button>
                <button type="button" class="btn_update_dossier mt-0 btn btn-dark" data-dismiss="modal">Modifier le Dossier</button>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <textarea id="commentaire" name="commentaire" type="text" class="commentaire form-control"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
