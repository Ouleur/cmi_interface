<div class="row">
    <div class="col-md-6 col-lg-6 col-xl-4">
        <a href="index.php?page=consulJour&module=accueil">

            <div class="mini-stat clearfix bg-white">
                <span class="mini-stat-icon bg-purple mr-0 float-right"><i class="mdi mdi-basket"></i></span>
                <div class="mini-stat-info">
                    <span class="counter_consul text-purple"></span>
                    Consultation du <?php setlocale (LC_TIME, 'fr_FR.utf8','fra'); 
print strftime("%d %B %Y");?>
                </div>
                <div class="clearfix"></div>
                <!-- <p class=" mb-0 m-t-20 text-muted">Consultation du jour: $22506 </p> -->
            </div>
        </a>
    </div>
    
    <div class="col-md-6 col-lg-6 col-xl-4">
        <a href="index.php?page=accidentDir&module=dashboard">

            <div class="mini-stat clearfix bg-white">
                <span class="mini-stat-icon bg-blue-grey mr-0 float-right"><i class="mdi mdi-black-mesa"></i></span>
                <div class="mini-stat-info">
                    <span class="counter_accident text-blue-grey"></span>
                    Accidents
                </div>
                <div class="clearfix"></div>
    ...
    <div class="col-md-6 col-lg-6 col-xl-4">
        <a href="index.php?page=consultationDir&module=dashboard">

            <div class="mini-stat clearfix bg-white">
                <span class="mini-stat-icon bg-brown mr-0 float-right"><i class="mdi mdi-buffer"></i></span>
                <div class="mini-stat-info">
                    <span class="consult_total text-brown"></span>
                    Toute consultation
                </div>
                <div class="clearfix"></div>
                <!-- <p class="text-muted mb-0 m-t-20">Total income: $22506 <span class="pull-right"><i class="fa fa-caret-up m-r-5"></i>10.25%</span></p> -->
            ...
            <div class="col-md-12 pr-md-0">
                <div class="card m-b-20" style="height: 486px;">
                    <div class="card-block">
                        <h4 class="mt-0 header-title">Pharmacie</h4>

                        <div class="text-center">
                            <div class="btn-group m-t-20" role="group" aria-label="Basic example">
                                <a href="index.php?page=pharmacie&module=dashboard" type="button" class="btn btn-secondary">Détail</a>
                            </div>
                        </div>

                        <div id="chartP" class="m-t-20"></div>
